...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNCS] = LAYOUT(
    ...
    KC_LNG,  _______, KC_UP,   _______, RGB_TOG, _______,                        KC_INS,  KC_PSCR, RGB_HUI, RGB_SAI, RGB_VAI, KC_F12,
    _______, KC_LEFT, KC_DOWN, KC_RGHT, RGB_MOD, _______,                        KC_HOME, KC_PGUP, RGB_HUD, RGB_SAD, RGB_VAD, KC_PAUS,
